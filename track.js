...
var tracks = [
    {id: 'game-1', board: game1},
    {id: 'game-2', board: game2},
    {id: 'game-3', board: game3},
    {id: 'game-4', board: game4},
]
...
function showCar(id) {
    ...
    carImg.setAttribute('src', 'art/car-red.png')
...
function getProps(element) {
    ...
    var props = {
        ...
        top: stripPx(ce.top),
        width: stripPx(ce.width),
        height: stripPx(ce.height),
    }
...
function getCompTop(element) {
    return parseInt(window.getComputedStyle(element).top.replace('px', ''))
}
function getCompLeft(element) {
    return parseInt(window.getComputedStyle(element).left.replace('px', ''))
}

function paintTrack(trackid) {
    var track = tracks.find((element) => {
...
function addSquare(square, squareTop, squareLeft) {
    ...
    img.setAttribute(
        'style',
        'top:' + squareTop + 'px;left:' + squareLeft + 'px'
    )
